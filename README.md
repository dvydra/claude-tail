...
carries a strip of the theme's colours ahead of its name, most visible first
(USER box, AGENT box, dim, body text, heading, inline code, bold, link), so `←→`
previews a palette before the transcript is redrawn in it. The session
